...
export const teampifyContent: WorkContentBlock[] = [
  {
    type: "paragraph",
    text: "After designing Teampify's brand identity, I was brought back to design the interface and experience of a web app (desktop only) helping project managers build their project teams.",
  },
  {
    type: "paragraph",
